...
Animation::Animation(Game& g, RenderWindow& w, Entity* e, const AnimInfo& a_i, const Transform& t) :
...
void Animation::Draw() {
    ...
    tex_rect = IntRect(Vector2i(anim_info.curr_frame * anim_info.sprite_w, anim_info.tex_row * anim_info.sprite_h), Vector2i(anim_info.sprite_w, anim_info.sprite_h));
